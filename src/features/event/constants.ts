        ...
        outcomes: [
          {
            ...
            resources: NO_RESOURCES,
            resourcesPerTurn: getResources({ Wood: 1 }),
            buildings: [],
            villagers: [],
            probability: 0.95,
          },
        ...
        outcomes: [
          {
            ...
            resources: NO_RESOURCES,
            resourcesPerTurn: getResources({ Stone: 1 }),
            buildings: [],
            villagers: [],
            probability: 0.95,
          },
        ...
        outcomes: [
          {
            ...
            buildings: [{ id: 9, state: "destroyed" }],
            villagers: [],
            probability: 0.5,
          },
          {
      ...
      },
      {
        ...
        outcomes: [
          ...
          },
          {
            ...
            resources: NO_RESOURCES,
            resourcesPerTurn: getResources({ Wood: -1, Stone: -1 }),
            buildings: [{ id: 9, state: "destroyed" }],
            villagers: [],
            probability: 0.5,
          },
